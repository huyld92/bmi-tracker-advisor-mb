...
class AddExerciseToWorkoutController extends GetxController {
  ...
  void onSelectExercise(int index) {
    ...
    Get.defaultDialog(
            ...
            child: TextFormField(
              ...
              onChanged: (value) {
                if (value.isNotEmpty) {
                  ...
                  calculatorCaloriesBurned(index, duration);
                } else {
      ...
      cancel: ElevatedButton(
        ...
        child: Text("txt_cancel".tr, style: CustomTextStyles.bodyMedium14White),
      ),
  ...
  void calculatorCaloriesBurned(int index, int duration) {
  ...
  Future<void> addExerciseToWorkout(int index, int duration) async {
    ...
    createWorkoutController.workoutExerciseRequests.add(WorkoutExerciseRequest(
